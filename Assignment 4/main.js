...
void main(){
  ...
  vec4 blend = af * colorForeground + (1.0 - af) * colorBackground;

  float gray = 0.2126*blend.r + 0.7152*blend.g + 0.0722*blend.b;
  vec4 grayscalecolor = vec4(gray, gray, gray, blend.a);

  float sr = 0.393*blend.r + 0.769*blend.g + 0.189*blend.b;
  float sg = 0.349*blend.r + 0.686*blend.g + 0.168*blend.b;
  float sb = 0.272*blend.r + 0.534*blend.g + 0.131*blend.b;
  vec4 sepia = vec4(sr,sg,sb,blend.a);
